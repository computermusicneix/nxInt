class nxInt001 {
  ...
  float nxInt001positionXTEMP,
  float nxInt001positionYTEMP,
  ...
  int nxInt001rotationTEMP){
    ...
    nxInt001positionX = nxInt001positionXTEMP;
    nxInt001positionY = nxInt001positionYTEMP;
  ...
  void display(){
    ...
    translate(((width)/nxInt001positionX),((height)/nxInt001positionY));
  ...
  void setPositionX(float positionX){
    nxInt001positionX = positionX;
  }
  void setPositionY(float positionY){
    nxInt001positionY = positionY;
  }
